...
<div style="max-width:720px;margin:0 auto;padding:24px;">
    ...
    <div style="background-color:#faf9f8;border:1px solid #edebe9;border-top:none;border-radius:0 0 8px 8px;padding:16px 32px;">
        <p style="margin:0;font-size:11px;color:#a19f9d;">Generated by the Secure Score drift runbook &middot; JSolve B.V. &middot; <a href="$portalUrl" style="color:#0078d4;">security.microsoft.com/securescore</a></p>
    </div>
</div>
</body>
</html>
